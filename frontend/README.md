...
Para desenvolver este jogo eu tive que investigar bastante para saber como que o jogo clássico connect four funciona,
Eu acho que é isso que nós dev's devemos fazer quando nos é dado um problema, antes de começar a resolve-lo
devemos analisar e começar a pensar como ele seria, devemos repartir cada ponto para tornar o problema cada vez menor
e para termos uma melhor visão de como iremos solucionar o problema.
